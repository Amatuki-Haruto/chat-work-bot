...
class Config:
    ...
    TOPIC_MESSAGE = "[info][title]今日の話題[/title]\n変人君は今日映画見に行きました、デーモンスレイヤーインフィニティーキャッスル編です(\n一応一回は見たんですけどなんか二回目見に行きました\n最初は渋々だったんですけど見たらちゃんと二回目でも面白かったです、いつ見ても猗窩座のところだけ長いです(\n最後のクライマックスのシーンで弟は涙うるうるだったんですけど私は涙出ませんでした\nそう...✝俺には感情が無い✝\n冗談です、皆さんは映画で泣いたりします？[/info]"
